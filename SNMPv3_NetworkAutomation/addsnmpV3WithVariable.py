...
auth_password = '$tc_device_snmpv3_password$'
priv_password = '$tc_device_snmpv3_encryption$'
...
print('Adding new User With Variable to new Group - ps-network-operator for PS lab setup\n')
session.send('snmp-server user $tc_device_snmpv3_username$ netmon-group1 v3 auth sha $tc_device_snmpv3_password$ priv aes 128 $tc_device_snmpv3_encryption$ access 7\n')
output = get_output(session)
print('\n' + output)
