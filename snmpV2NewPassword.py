...
print('snmp-server community newsnmpro RO\n')
session.send('snmp-server community newsnmpro RO\n')
output = get_output(session)
print('\n' + output)
...
print('snmp-server community newsnmprw RW\n')
session.send('snmp-server community newsnmprw RW\n')
output = get_output(session)
print('\n' + output)
