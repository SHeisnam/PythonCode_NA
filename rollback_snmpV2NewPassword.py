...
print('we are removing the read-only SNMP community strings with newsnmpro\n')
print('no snmp-server community newsnmpro RO\n')
session.send('no snmp-server community newsnmpro RO\n')
output = get_output(session)
print('\n' + output)
...
print('we are removing the read-write SNMP community strings with newsnmprw\n')
print('NO snmp-server community newsnmprw RW\n')
session.send('no snmp-server community newsnmprw RW\n')
output = get_output(session)
print('\n' + output)
